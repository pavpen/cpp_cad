#ifndef _CPP_CAD_OPERATION_LOGGING_POLYHEDRON_BUILDER_H
#define _CPP_CAD_OPERATION_LOGGING_POLYHEDRON_BUILDER_H
...
#endif // _CPP_CAD_OPERATION_LOGGING_POLYHEDRON_BUILDER_H
